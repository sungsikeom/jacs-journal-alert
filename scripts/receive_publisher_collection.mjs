...
const configs = {
  ...
  jcim: { output: "jcim_articles.json", minimum: 200, url: "https://pubs.acs.org/jcisd8/search-results?sort=Date+-+Newest+First&f_ContentType=Journal+Articles&qb=%7B%22q%22%3A%22%22%7D&page=1#publisher-auto" },
